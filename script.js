...
const QUESTIONS_DB = {
  "Игры": {
    10: { question: "На чём, кроме ПК и смартфона, играют в видеоигры?",
         answer: "консоли", options: ["консоли", "телевизор", "Калькулятор", "Тест на беременность"], is_played: false },
    20: { question: "Мельчайшая точка изображения на экране?",
         answer: "пиксель", options: ["пиксель", "байт", "Вектор", "кадр"], is_played: false },
  ...
  "Двоичный код": {
    ...
    40: { question: "Чему равно число 10 в двоичной системе?",
